function calcola(attaccogiocatore, difesaGiocatore) {
    var nemicoList = document.getElementById("nemico");
    var hpNemico = parseInt(nemicoList.dataset.hp);
    var attaccoNemico = parseInt(nemicoList.dataset.attacco);
    var difesaNemico = parseInt(nemicoList.dataset.difesa);
    var tipologiaNemico = nemicoList.dataset.tipologia;
    var isBoss = nemicoList.dataset.isboss;
